...
function FAQ() {
  return (
    <div>
        <div>
                <div className="relative flex items-center justify-center py-16 m-10 bg-gradient-to-b from-blue-500 to-blue-400">
                    <div>
                        <h1 className="text-3xl font-bold leading-10 text-white sm:text-4xl lg:text-5xl">How can we help you?</h1>
                        <div className="relative flex items-center w-full py-4 pl-4 mt-6 bg-blue-700 rounded lg:mt-14">
                            <div>
                    ...
                    <div className="mt-9 md:mt-11 lg:mt-16">
                        ...
                        <div role="list" aria-label="Our Team mates" className="flex flex-wrap items-center justify-around mt-2 ">
                            <div role="listitem" className="focus:outline-none">
                                ...
                                <p className="mt-2 text-base font-semibold leading-none text-green-500">Julia John</p>
                                <p className="mt-2 text-base leading-none text-blue-500">Designer</p>
                            </div>
                            <div role="listitem" className="focus:outline-none">
                                ...
                                <p className="mt-2 text-base font-semibold leading-none text-green-500">Tom Koch</p>
                            ...
                            <div role="listitem" className="focus:outline-none">
                                ...
                                <p className="mt-2 text-base font-semibold leading-none text-green-500">Kera Ann</p>
                                <p className="mt-2 text-base leading-none text-blue-500">Designer</p>
                            </div>
                            <div role="listitem" className="focus:outline-none">
                                ...
                                <p className="mt-2 text-base font-semibold leading-none text-green-500">Glenn Jo</p>
                                <p className="mt-2 text-base leading-none text-blue-500">Support</p>
                            </div>
                            <div role="listitem" className="focus:outline-none">
                                ...
                                <p className="mt-2 text-base font-semibold leading-none text-green-500">Xhing Co</p>
                                <p className="mt-2 text-base leading-none text-blue-500">Support</p>
                            </div>
                        </div>
