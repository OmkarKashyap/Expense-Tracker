...
function Testimonials() {
  return (
    <div className="h-screen text-white bg-black">
        <div>
                <h2 className="px-4 text-2xl font-semibold leading-6 text-center text-blue-400 font-Poppins">Testimonials</h2>
                <h1 className="px-4 mt-6 text-2xl font-semibold leading-10 text-center text-white font-Poppins lg:text-5xl md:text-4xl">What our <span className="text-green-500">clients</span> say :</h1>
                <div className="container grid gap-6 px-10 py-20 mx-auto sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:px-20">
                    <div>
                        <div className="relative flex flex-col items-center w-full p-6 bg-white shadow-md cursor-pointer group hover:bg-green-500 md:p-12">
                            <div className="flex flex-col items-center text-gray-600 group-hover:text-black">
                            ...
                            <div className="absolute bottom-0 -mb-6 text-white group-hover:text-green-500">
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            ...
                            <p className="my-2 text-base font-semibold leading-4 text-green-500">Tom Koch</p>
                            <p className="text-base leading-4 text-center text-blue-500">Developer</p>
                        </div>
                    </div>
                    <div>
                        <div className="relative flex flex-col items-center w-full p-6 bg-white shadow-md cursor-pointer group hover:bg-green-500 md:p-12">
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            ...
                            <p className="my-2 text-base font-semibold leading-4 text-green-500">Alan Max</p>
                            <p className="text-base leading-4 text-center text-blue-500">Designer</p>
                        </div>
                    </div>
                    <div>
                        <div className="relative flex flex-col items-center w-full p-6 bg-white shadow-md cursor-pointer group hover:bg-green-500 md:p-12">
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            ...
                            <p className="my-2 text-base font-semibold leading-4 text-green-500">Kera Joo</p>
                            <p className="text-base leading-4 text-center text-blue-500">Support</p>
                        </div>
                    </div>
                </div>
            </div>
