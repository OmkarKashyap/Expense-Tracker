        ...
        <div>
                    ...
                    <ul className="mt-5">
                        <li className="flex items-center justify-between w-full mb-6 text-gray-200 cursor-pointer hover:text-gray-500">
                            <div className="flex items-center">
                                ...
                                <Link to="/user/dashboard"><span className="ml-2 text-sm">Dashboard</span></Link>
                            </div>
                            <div className="flex items-center justify-center px-3 py-1 text-xs text-gray-400 bg-gray-700 rounded">5</div>
                        </li>
                        <li className="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-500">
                            <div className="flex items-center">
                                ...
                                <Link to="/user/transactions"><span className="ml-2 text-sm">Transactions</span></Link>
                            </div>
                            <div className="flex items-center justify-center px-3 py-1 text-xs text-gray-400 bg-gray-700 rounded">8</div>
                        </li>
                        <li className="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-500">
                            <div className="flex items-center">
                                ...
                                <Link to="/user/incomes"><span className="ml-2 text-sm">Incomes</span></Link>
                            </div>
                        </li>
                        <li className="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-500">
                            <div className="flex items-center">
                                ...
                                <Link to="/user/expenses"> <span className="ml-2 text-sm">Expenses</span></Link>    
                            </div>
                        </li>
                        <li className="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-500">
                            <div className="flex items-center">
                            ...
                            <div className="flex items-center justify-center px-3 py-1 text-xs text-gray-400 bg-gray-700 rounded">25</div>
                        </li>
                        <li className="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-500">
                            <div className="flex items-center">
                        ...
                        <li className="flex items-center justify-between w-full text-gray-400 cursor-pointer hover:text-gray-500">
                            <div className="flex items-center">
            ...
            <div className={show ? "w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out transform -translate-x-full" : "w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out transform -translate-x-0"} id="mobile-nav">
                ...
                <div className="px-8">
                    ...
                    <div className="flex justify-center w-full mt-48 mb-44">
                        <div className="relative ">
